...
import { aprovarAction, rejeitarAction } from "./actions";
        ...
        {filtros.map((f) => (
          <button
            ...
            style={{
              ...
              background: filtro === f
                ? (f === "todos" ? "#FFB800" : statusConfig[f as Status].color)
                : "#131A2B",
      ...
      {modalId !== null && (
        ...
        >
          ...
          >
            ...
            <p style={{ fontSize: 13, color: "#7A839A", margin: "0 0 18px" }}>
              Informe o motivo da rejeicao (o parceiro sera notificado por e-mail).
            </p>
            <form action={rejeitarAction}>
              ...
              <textarea
                name="motivo"
                required
                placeholder="Ex: Documentacao incompleta..."
                rows={4}
                style={{
              ...
              <div style={{ display: "flex", gap: 10, marginTop: 18 }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    background: "rgba(255,92,122,.20)", color: "#FF5C7A",
